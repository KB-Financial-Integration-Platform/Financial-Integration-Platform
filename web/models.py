...
# Card.objects.create(age="20대", card_name="위글위글 첵첵 체크카드", benefit1="대중교통 2-4천원 청구할인 ", benefit2="온라인간편결제 2-4천원 환급", benefit3="스타벅스 2-4천원 환급")
# Card.objects.create(age="30대", card_name="노리 체크카드", benefit1="대중교통 10% 청구할인", benefit2="이동통신요금 2,500원 환급", benefit3="CGV 35% 환급")
# Card.objects.create(age="40대", card_name="골든대로 체크카드", benefit1="병원/약국 5% 적립", benefit2="대형마트/홈쇼핑 5% 적립", benefit3="골프/사우나 5% 적립")

# Consume.objects.create(User.id,food=413910, cafe=154800, shopping=100440, education=67500, leisure=72150, medical=25000, traffic=26650, life=25135, travel=57500)